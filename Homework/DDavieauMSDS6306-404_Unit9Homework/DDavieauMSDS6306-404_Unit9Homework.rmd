...
IMDB_Source<-GET(url=siteurl)
IMDB_Raw<-xmlParse(siteurl, isHTML = TRUE)
IMDB_Raw<-htmlTreeParse(siteurl)
IMDB_Root<-xmlRoot(IMDB_Raw)
IMDB_Children<-xmlChildren(IMDB_Root)
xmlNamespace(IMDB_Root)
xmlName(IMDB_Root)
xmlSize(IMDB_Root)
class(IMDB_Raw)
class(IMDB_Root)
IMDB_Children<-xmlChildren(IMDB_Root)
class(IMDB_Children)
RootChildren<-xmlChildren(IMDB_Root)
getNodeSet(IMDB_Raw, "//name")
IMDB_NAmes<-getNodeSet(IMDB_Raw, "//name")
xmlSize(IMDB_Root)
xmlSApply(IMDB_Root, xmlName)
IMDB_body = xmlChildren(IMDB_Root)$body
xpathSApply(IMDB_body, "h1")
xpathSApply(IMDB_body, "h2")
IMDB_Content<- readHTMLTable(IMDB_Raw,which = 1)
IMDB_Content<- readHTMLTable(IMDB_body,which = 1)
IMDB_Children<-xmlChildren(IMDB_Root)
RootChildren<-xmlChildren(IMDB_Root)
getNodeSet(IMDB_Raw, "//name")
IMDB_NAmes<-getNodeSet(IMDB_Raw, "//name")
IMDB_xml_Names<-xmlSApply(IMDB_Root, xmlName)
IMDB_body = xmlChildren(IMDB_Root)$body
