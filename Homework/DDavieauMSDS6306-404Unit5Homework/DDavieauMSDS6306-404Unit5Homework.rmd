...
```{r}
tail(y2015, 10)
###Hmm never thought there were so many names that begin with the letter Z
```
######c.	Merge y2016 and y2015 by your Name column; assign it to final.  The client only cares about names that have data for both 2016 and 2015; there should be no NA values in either of your amount of children rows after merging.
```{r}
#added Gender to merge to avoid duplicates
final<-MergeData1 <- merge(x= y2015, y=y2016, by = c("Name","Gender"), all=FALSE)
#final<-MergeData1 <- merge(x= y2015, y=y2016, by = "Name", all=FALSE)
```
...
```{r}
write.table(Top10, file = "Top10GirlNames.csv", col.names = FALSE, sep = ",")
```
